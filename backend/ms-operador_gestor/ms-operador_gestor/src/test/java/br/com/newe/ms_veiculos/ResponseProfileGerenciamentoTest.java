...
class ResponseProfileGerenciamentoTest {
        ...
        @Test
        void gestorDeveReceberRespostaGerencialENuncaOperacional() {
                ...
                Object resposta = gerenciamento.criarResposta(authentication, operacional, gerencial);
        ...
        @Test
        void operadorDeveReceberRespostaOperacionalENuncaGerencial() {
